...
class TestExprWithUnit(unittest.TestCase):
  ...
  def test_factor_to(self) -> None:
    ...
    self.assertEqual((a / b + a / b)._repr_latex_(), '$\\frac{200 a}{b}~\\mathrm{[1]}$')
  ...
  def test_convert_to_base(self) -> None:
    ...
    self.assertEqual((a / b)._repr_latex_(), '$\\frac{1000 a}{b}~\\mathrm{[1]}$')
    self.assertEqual((a / b * b)._repr_latex_(), '$a~\\mathrm{[\\text{m}]}$')
